<template>
  <div id="app">
      <section>
        <h2>Slots</h2>
        <vue-auto-dropzone ref="dz1" :options="options" v-slot="{ files, uploadingFiles, acceptedFiles, rejectedFiles, removeFile }" :include-styling="false">
            <div>
    ...
    <section>
        <h2>Default</h2>
        <vue-auto-dropzone ref="dz2" :options="options" />
    </section>
    <!--
    <section>
        <h2>No styling</h2>
